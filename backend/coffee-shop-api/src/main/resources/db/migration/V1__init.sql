...
CREATE INDEX idx_coffee_bean_active ON coffee_bean(active);
CREATE INDEX idx_coffee_bean_roast ON coffee_bean(roast);
CREATE INDEX idx_coffee_bean_origin ON coffee_bean(origin);
-- Optional seed data so your UI has something immediately
